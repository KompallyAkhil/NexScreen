...
class ResumeFields(BaseModel):
    ...
    experience_years: float = Field(description="Total years of professional experience, 0 if student")
...
_RESUME_PROMPT = ChatPromptTemplate.from_messages([
    ...
    ("human",
        ...
        "- experience_years (number): Total years of professional experience, 0 if student\n"
