...
A production-quality resume scoring pipeline built with **LangGraph**, **LangChain**, and **Google Gemini**.  
...
```json
{
  ...
  "band": "Strong fit",
  "components": {
    "semantic_similarity": { "score": 81.2, "weight": 0.45, "contribution": 36.5 },
    "llm_holistic_judge":  { "score": 74.0, "weight": 0.35, "contribution": 25.9 },
    "keyword_overlap":     { "score": 80.3, "weight": 0.20, "contribution": 16.1 }
  },
  "skill_analysis": {
  ...
  "llm_assessment": {
    ...
    "strengths": ["Solid Python/FastAPI experience", "PostgreSQL expertise", "System design skills"],
...
│   ├── llm_judge_node.py      # Gemini holistic fit judge
...
GEMINI_MODEL=gemini-1.5-flash  # default — fast and cheap
```
